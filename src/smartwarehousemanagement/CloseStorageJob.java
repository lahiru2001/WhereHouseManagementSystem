 ...
 * @author Lahiru
 */
public class CloseStorageJob extends javax.swing.JFrame {
    ...
    public ArrayList<storageJob> storageList(){
        ArrayList<storageJob> storageList = new ArrayList();
        
        try{
            
            String query = "SELECT * FROM storage_job";
            stmt = con.prepareStatement(query);
            rs = stmt.executeQuery();
            storageJob sjob;
            while(rs.next()){
            sjob =  new storageJob(rs.getString("user_id"),rs.getString("customer_name"),rs.getString("product_name"),rs.getString("product_code"),rs.getString("unit"),rs.getString("date"),rs.getString("duration"),rs.getString("avalibility"));
            storageList.add(sjob);
            }
    ...
    public void showstorage(){
        ...
        ArrayList<storageJob> list = storageList(); 
        DefaultTableModel model = (DefaultTableModel)ShowStorage.getModel();
        ...
        for(int i=0; i<list.size(); i++)
        {
           ...
           row[6] = list.get(i).getDuration();
           row[7] = list.get(i).getAvalibility();
           model.addRow(row);
        }
    }
    ...
    private void initComponents() {
        ...
        ShowStorage = new javax.swing.JTable();
        btn_closestoragejob = new javax.swing.JButton();
        ...
        btn_closestorage.setBackground(new java.awt.Color(85, 65, 118));
        ...
        jLabel16.setText("CLOSE EXSISTING STRORAGE JOB");
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                .addGap(165, 165, 165)
                .addComponent(jLabel16, javax.swing.GroupLayout.PREFERRED_SIZE, 588, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        bg.add(jPanel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(260, 0, 940, 80));

        jLabel17.setFont(new java.awt.Font("Segoe UI", 1, 18)); // NOI18N
        jLabel17.setText("SEARCH");
        bg.add(jLabel17, new org.netbeans.lib.awtextra.AbsoluteConstraints(300, 140, 80, -1));
        ...
        bg.add(txtsearch, new org.netbeans.lib.awtextra.AbsoluteConstraints(400, 140, 210, 30));

        ShowStorage.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {

            },
            new String [] {
                "user id", "Full Name", "Product Code", "Product Name", "unit(kg)", "Arrival Date", "Duaration", "Avalibility"
            }
        ));
        jScrollPane1.setViewportView(ShowStorage);

        bg.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(300, 220, 870, 250));

        btn_closestoragejob.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        btn_closestoragejob.setForeground(new java.awt.Color(0, 0, 204));
        btn_closestoragejob.setText("Close Storage Job");
        btn_closestoragejob.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btn_closestoragejobActionPerformed(evt);
            }
        });
        bg.add(btn_closestoragejob, new org.netbeans.lib.awtextra.AbsoluteConstraints(300, 500, 220, 30));
    ...
    private void btn_dashMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btn_dashMousePressed
        ...
        CloseStorageJob reguser = new CloseStorageJob();
    ...
    private void btn_closestoragejobActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_closestoragejobActionPerformed
        // TODO add your handling code here:
        
        
        try { 
        int row = ShowStorage.getSelectedRow();
        String user_id = ShowStorage.getValueAt(row, 0).toString();
      
            String sqlc = "UPDATE storage_job SET avalibility = 'Close' where user_id= ?";
            stmt = con.prepareStatement(sqlc);
            stmt.setString(1, user_id);
            stmt.executeUpdate();

            int a = JOptionPane.showConfirmDialog(null,"DO YOU want to Close This Storage Job","Select",JOptionPane.YES_NO_OPTION);
            if(a == 0){
                CloseStorageJob csj = new CloseStorageJob();
                csj.setVisible(true);
                this.setVisible(false);
                txtsearch.requestFocus();
                JOptionPane.showMessageDialog(null,"Close storage job successfully");
            }
        } catch (SQLException ex) {
            JOptionPane.showMessageDialog(null,"DB connection Error"+ex.getMessage(),"ERROR",JOptionPane.ERROR_MESSAGE);
            Logger.getLogger(CloseStorageJob.class.getName()).log(Level.SEVERE, null, ex);
        }
    }//GEN-LAST:event_btn_closestoragejobActionPerformed
   ...
   void resetColor(JPanel panel)
   {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CloseStorageJob.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CloseStorageJob().setVisible(true);
            }
        });
    }

    // Variables declaration - do not modify//GEN-BEGIN:variables
    private javax.swing.JTable ShowStorage;
    ...
    private javax.swing.JButton btn_closestoragejob;
